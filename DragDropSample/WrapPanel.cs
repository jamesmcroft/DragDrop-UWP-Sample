namespace DragDropSample
{
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            foreach (var element in this.Children)
            {
                ...
                if (NumericExtensions.IsGreaterThan(lineSize.Direct + elementSize.Direct, maximumSize.Direct))
                {
                    ...
                    totalSize.Direct = System.Math.Max(lineSize.Direct, totalSize.Direct);
                    ...
                    if (NumericExtensions.IsGreaterThan(elementSize.Direct, maximumSize.Direct))
                    {
                        ...
                        // single element
                        totalSize.Direct = System.Math.Max(elementSize.Direct, totalSize.Direct);
                ...
                else
                {
                    ...
                    lineSize.Indirect = System.Math.Max(lineSize.Indirect, elementSize.Indirect);
                }
            }
    ...
    internal static class NumericExtensions
    {
        ...
        public static bool IsZero(this double value)
        {
            ...
            // epsilon to be zero
            return System.Math.Abs(value) < 2.2204460492503131E-15;
        }
#endif
        ...
        public static bool AreClose(double left, double right)
        {
            ...
            double a = (System.Math.Abs(left) + System.Math.Abs(right) + 10.0) * 2.2204460492503131E-16;
            double b = left - right;
            return (-a < b) && (a > b);
        }
